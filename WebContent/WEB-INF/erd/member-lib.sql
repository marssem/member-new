...
CREATE SEQUENCE SEQ_lant_l_num INCREMENT BY 1 START WITH 1;
...
CREATE OR REPLACE TRIGGER TRI_lant_l_num BEFORE INSERT ON lant
FOR EACH ROW
BEGIN
	SELECT SEQ_lant_l_num.nextval
	INTO :new.l_num
	FROM dual;
END;
